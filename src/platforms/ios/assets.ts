 ...
 * - iPhone App (iOS 5,6)
 */
export const IOS_57_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
  name: 'icon.png',
  format: Format.Png,
...
export const IOS_57_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
  name: 'icon@2x.png',
  format: Format.Png,
 ...
 * - iPhone App (iOS 7+)
 */
export const IOS_60_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
...
export const IOS_60_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
...
export const IOS_60_PT_3X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - iPad App (iOS 5,6)
 */
export const IOS_72_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
...
export const IOS_72_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - iPad App (iOS 7+)
 */
export const IOS_76_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
...
export const IOS_76_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * iPad Pro (12.9-inch)
 */
export const IOS_83_5_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - App Store
 */
export const IOS_1024_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - Apple Watch Notification Center
 */
export const IOS_24_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - Apple Watch Notification Center
 */
export const IOS_27_5_PT_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - Apple Watch Home Screen
 */
export const IOS_44_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 */
export const IOS_86_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - Apple Watch Short Look
 */
export const IOS_98_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
 ...
 * - Apple Watch Short Look
 */
export const IOS_108_PT_2X_ICON: AssetMeta = {
  platform: Platform.Ios,
  kind: AssetKind.Icon,
